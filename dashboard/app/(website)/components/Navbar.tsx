          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <button 
                ...
                className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-bold transition-colors shadow-lg hover:shadow-xl border border-green-500"
              >
                GET STARTED
              </button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-black/80 backdrop-blur-md border-t border-white/20">
            <div className="px-4 py-4 space-y-4">
              <Link href="/marketplace">
                <button 
                  className="block w-full text-left text-white hover:text-green-300 font-semibold py-2 transition-colors"
              ...
              <button 
                onClick={() => openAuthModal('signup')}
                className="block w-full bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors font-bold text-center shadow-lg"
              >
                GET STARTED
              </button>
            </div>
